...
"""
    ...
    def _testReadXML(self, charcol):
        self.assertEqual(charcol.get_set_list(), ["一", "三", "二", "四"])
        ...
        self.assertEqual(charcol.get_characters("一"),
                          [c["19968_1"], c["19968_2"], c["19968_3"]])
        self.assertEqual(charcol.get_characters("三"),
                          [c["19977_1"], c["19977_2"]])
        self.assertEqual(charcol.get_characters("二"),
                          [c["20108_1"]])
        self.assertEqual(charcol.get_characters("四"), [])
        self.assertEqual(charcol.get_all_characters(),
                          [c["19968_1"], c["19968_2"], c["19968_3"],
    ...
    def testToXML(self):
        ...
        self.assertEqual(self.cc.get_set_list(), charcol2.get_set_list())
        self.assertEqual(self.cc.get_all_characters(),
    ...
    def testAddSame(self):
        ...
        self.assertEqual(charcol3.get_set_list(), ["一", "三", "二", "四"])
        self.assertEqual(len(charcol3.get_characters("一")), 3)
        self.assertEqual(len(charcol3.get_characters("三")), 2)
        self.assertEqual(len(charcol3.get_characters("二")), 1)
        self.assertEqual(len(charcol3.get_characters("四")), 0)

    def testGetChars(self):
        all_ = self.cc.get_characters("一")
        self.assertEqual(self.cc.get_characters("一", limit=2), all_[0:2])
        self.assertEqual(self.cc.get_characters("一", offset=2), all_[2:])
        self.assertEqual(self.cc.get_characters("一", limit=1, offset=1),
                          all_[1:2])
    ...
    def testAdd(self):
        ...
        self.assertEqual(len(charcol3.get_characters("二")), 1)
        self.assertEqual(len(charcol3.get_characters("四")), 0)
        self.assertEqual(len(charcol3.get_characters("a")), 3)
        self.assertEqual(len(charcol3.get_characters("b")), 2)
        self.assertEqual(len(charcol3.get_characters("c")), 1)
        self.assertEqual(len(charcol3.get_characters("d")), 0)
    ...
    def testFromCharDirRecursive(self):
        ...
        self.assertEqual(sorted(charcol.get_set_list()),
                          sorted(["yo", "防", "三", "一", "二"]))
        self.assertEqual(len(charcol.get_characters("一")), 3)
        self.assertEqual(len(charcol.get_characters("三")), 2)
        self.assertEqual(len(charcol.get_characters("二")), 1)
        self.assertEqual(len(charcol.get_characters("防")), 1)

    def testFromCharDirNotRecursive(self):
        directory = os.path.join(self.currdir, "data")
        charcol = CharacterCollection.from_character_directory(directory,
                                        recursive=False, check_duplicate=True)
        self.assertEqual(charcol.get_set_list(), ["防"])
        self.assertEqual(len(charcol.get_characters("防")), 1)

    def testIncludeChars(self):
        self.cc.include_characters_from_text("一三")
        self.assertEqual(self.cc.get_set_list(), ["一", "三"])

    def testExcludeChars(self):
        self.cc.exclude_characters_from_text("三")
        self.assertEqual(self.cc.get_set_list(), ["一", "二"])
    ...
    def testAddSet(self):
        ...
        self.assertEqual(self.cc.get_set_list()[-1], "toto")
    ...
    def testRemoveSet(self):
        ...
        self.assertEqual(before[0:-1], after)

    def testGetNSets(self):
        self.assertEqual(len(self.cc.get_set_list()), self.cc.get_n_sets())
        self.assertEqual(4, self.cc.get_n_sets())

    def testGetTotalNCharacters(self):
        self.assertEqual(len(self.cc.get_all_characters()),
                          self.cc.get_total_n_characters())
        self.assertEqual(6, self.cc.get_total_n_characters())

    def testGetNCharacters(self):
        for set_name in self.cc.get_set_list():
            self.assertEqual(len(self.cc.get_characters(set_name)),
                              self.cc.get_n_characters(set_name))

        self.assertEqual(self.cc.get_n_characters("一"), 3)
        self.assertEqual(self.cc.get_n_characters("三"), 2)
        self.assertEqual(self.cc.get_n_characters("二"), 1)
    ...
    def testRemoveSamples(self):
        ...
        self.assertEqual(self.cc.get_n_characters("一"), 2)
        self.assertEqual(self.cc.get_n_characters("三"), 2)
        self.assertEqual(self.cc.get_n_characters("二"), 1)

        self.cc.remove_samples(keep_at_most=1)
        self.assertEqual(self.cc.get_n_characters("一"), 1)
        self.assertEqual(self.cc.get_n_characters("三"), 1)
        self.assertEqual(self.cc.get_n_characters("二"), 1)

    def testRemoveEmptySets(self):
        self.cc.remove_empty_sets()
        self.assertEqual(self.cc.get_set_list(), ["一", "三", "二"])
